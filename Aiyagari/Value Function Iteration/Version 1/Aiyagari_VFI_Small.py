...
markets and idiosyncratic income risk as in Aiyagari (1994) using discrete value function iteration. There are two income states 
    ...
    def solve_model(self):
        ...
        if self.plott:
            ...
            if self.full_euler_error:
                ...
                plt.xlabel('Assets')
                #plt.savefig('log10_euler_error_vfi_aiyagari_small.pdf')
                plt.show()
            ...
            if self.distribution_method == 'discrete' or self.distribution_method == 'eigenvector':
                ...
                plt.xlabel('Assets')
                plt.legend(['z='+str(self.grid_z[0]),'z='+str(self.grid_z[1])])
                #plt.savefig('joint_density_vfi_aiyagari_small_discrete.pdf') if self.distribution_method == 'discrete' else plt.savefig('joint_density_vfi_aiyagari_small_eigenvector.pdf')
                plt.show()
                ...
                plt.xlabel('Assets')
                #plt.savefig('wealth_density_vfi_aiyagari_small_discrete.pdf') if self.distribution_method == 'discrete' else plt.savefig('wealth_density_vfi_aiyagari_small_eigenvector.pdf')
                plt.show()
            ...
            if self.distribution_method == 'monte carlo':
                ...
                plt.xlabel('Assets')
                #plt.savefig('wealth_density_vfi_aiyagari_small_montecarlo.pdf')
                plt.show()
