...
linear interpolation. The continuous income process is discretely approximated using the Rouwenhorst method.
...
class AiyagariPFI:
    ...
    """
    Class object of the model. AiyagariPFI().solve_model() runs everything
    """
    ...
    def solve_model(self):
        ...
        if self.plott:
            ...
            plt.xlabel('Assets')
            #plt.savefig('savings_policyfunction_pfi_aiyagari.pdf')
            plt.show()
            
            plt.plot(self.grid_a, self.pol_cons.T)
            plt.title("Consumption Policy Function")
            plt.xlabel('Assets')
            #plt.savefig('consumption_policyfunction_pfi_aiyagari.pdf')
            plt.show()
            ...
            if self.full_euler_error:
                ...
                plt.xlabel('Assets')
                #plt.savefig('log10_euler_error_pfi_aiyagari.pdf')
                plt.show()
            ...
            if self.distribution_method == 'discrete' or self.distribution_method == 'eigenvector':
                ...
                plt.xlabel('Assets')
                #plt.savefig('wealth_density_pfi_aiyagari_discrete.pdf') if self.distribution_method == 'discrete' else plt.savefig('wealth_density_pfi_aiyagari_eigenvector.pdf')
                plt.show()
            ...
            if self.distribution_method == 'monte carlo':
                ...
                plt.xlabel('Assets')
                #plt.savefig('wealth_density_pfi_aiyagari_montecarlo.pdf')
                plt.show()
