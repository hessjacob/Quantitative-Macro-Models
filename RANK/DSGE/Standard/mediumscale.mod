%Calibrated medium-scale DSGE based on Sim's NGDP, Sim's notes and JFV 2006. No ZLB. 
...
stoch_simul(order=1,irf=20,periods=5000,nograph) Pi R dY dC dNd dI dw Y Xg log_A C;
%stoch_simul(order=1,irf=20,hp_filter=1600,nograph) Pi R log_Y log_C log_Nd log_I log_w;
