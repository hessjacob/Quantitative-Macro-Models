...
AR(1) income process using the Rouwenhorst method (Tauchen is also an option in the code) 2) value function iteration to solve the household problem 3) approximation of the stationary distribution using 
